...
masks = ['Python', 'JavaScript', 'C#']
list_repo = [obj for obj in lst if obj['language']==masks[0]]
print(len(list_repo))
...
for repo in list_sorted[:5]:
    values = [repo['created_at'].split('T')[0], repo['name'], \
              repo['language'], repo['url'], repo['description']]
